...
program fortran_assignment
    ...
    do var6 = 1, 12
        write(10, '(I4,2X,F9.2)') Nzone_month(var6), Nzone_avg(var6)        
    end do
    close(10)
    ...
    do var12 = 1, 12
        write(40,'(I4,2X,F9.2)') Fzone_month(var12), Fzone_avg(var12)        
    end do
    close(40)! close file
    ...
    do var18 = 1, 12
        write(60,'(I4,2X,F9.2)') Tzone_month(var18), Tzone_avg(var18)        
    end do
